...
export function CustomersFilters({ currentSort, currentSearch }: CustomersFiltersProps) {
    ...
    function updateFilters(params: { orden?: string; buscar?: string }) {
        ...
        startTransition(() => {
            router.push(`/admin/clientes?${newParams.toString()}`)
        })
    }
            ...
            <form onSubmit={handleSearch} className="flex gap-2 sm:ml-auto">
                <div className="relative">
                    ...
                    <Input
                        ...
                        className="w-full sm:w-64 pl-9 h-9 bg-zinc-900 border-zinc-700 text-white placeholder:text-zinc-500 focus:border-red-500 font-mono uppercase"
                    />
                    {search && (
                        <button
                            type="button"
